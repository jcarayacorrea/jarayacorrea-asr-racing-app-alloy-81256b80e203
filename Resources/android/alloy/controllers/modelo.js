function Controller() {
    ...
    var exports = {};
    var __defers = {};
    $.__views.modelo = Ti.UI.createWindow({
        id: "modelo"
    });
    $.__views.modelo && $.addTopLevelView($.__views.modelo);
    modeloOpen ? $.__views.modelo.addEventListener("open", modeloOpen) : __defers["$.__views.modelo!open!modeloOpen"] = true;
    ...
    _.extend($, $.__views);
    __defers["$.__views.modelo!open!modeloOpen"] && $.__views.modelo.addEventListener("open", modeloOpen);
